...
function Header() {
    ...
    return (
        <section className='sticky top-0 z-30 bg-white'>
            ...
            <div className='relative w-full sticky top-0 pb-1 bg-white'>
                    ...
                    <section className='grid w-full flex-nowrap grid-cols-3 text-xs justify-around items-center my-3 md:my-5'>
                        <div className='ms-2 md:ms-5 xl:block hidden'>
                            <ul className='flex flex-wwrap gap-3 md:gap-5'>
                                <li><Link to='' onClick={() => menuclick(1)} className=''>MEN</Link></li>
                                <li><Link to='' onClick={() => menuclick(2)}>WOMEN</Link></li>
                                <li><Link to='' onClick={() => menuclick(3)}>KIDS</Link></li>
                                <li><Link to='' onClick={() => menuclick(4)}>SOCKS</Link></li>
                                <li><Link to='' onClick={() => menuclick(5)}>SALE</Link></li>
                            </ul>
                        ...
                        <div className='me-5'>
                            <div className='ms-5'>
                                <ul className='flex flex-wwrap lg:gap-5 items-center justify-end xl:justify-center'>
                                    <li><Link to='' className='uppercase hidden xl:block'>Sustainability</Link></li>
                                    <li><Link to='' className='uppercase hidden xl:block'>ReRun</Link></li>
                                    <li><Link to='' className='uppercase hidden xl:block'>stores</Link></li>
